...
(function() {
	...
	tinymce.create('tinymce.plugins.ThclPlugin', {
		...
		init : function(ed, url) {
			...
			ed.addCommand('mceThcl', function() {
				ed.windowManager.open({
					file : url + '/dialog.htm',
					width : 600 + parseInt(ed.getLang('thcl.delta_width', 0)),
					height : 380 + parseInt(ed.getLang('thcl.delta_height', 0)),
					inline : 1
				}, {
			...
			ed.onNodeChange.add(function(ed, cm, n) {
				cm.setActive('thcl', n.nodeName == 'IMG');
			});
		},
