$(document).ready(function () {
    ...
    var table = $('#datatable').DataTable({
        ...
        buttons : [
            ...
            {text : '<i class="fa fa-unlock"></i> Duyệt đăng', action : bunk_public, className:"btn btn-sm btn-info"},
            {text : '<i class="fa fa-lock"></i> Tạm khóa', action : bunk_lock, className:"btn btn-sm btn-warning"},
        ],
        order: [[0, 'desc']],
