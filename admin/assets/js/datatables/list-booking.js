    ...
    var table = $('#datatable').DataTable({
        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: function (data, type, full, meta) {
                    var txt = '';
                    txt += '<a href="'+baseUrl+'booking/edit/'+data+'" class="btn btn-xs btn-default" title="Sửa"><i class="fa fa-pencil blue"></i></a>';
        ...
        buttons : [
            ...
            {text : '<i class="fa fa-eye-slash"></i> Đánh dấu đã xử lý', action : bunk_delete, className:"btn btn-sm btn-warning"},
