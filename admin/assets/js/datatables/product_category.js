$(document).ready(function () {
    ...
    var table = $('#datatable').DataTable({
        ...
        "serverSide": true,
        ajax: {
            url : domain + 'product_category/getCategoryData',
            type:'post',
            data : function(d) {
        ...
        columnDefs: [
            ...
            },
            {
                ...
                render : function (data, type, full, meta) {
                    var txt = '';
                    txt += '<a href="'+baseUrl+'product_category/edit/'+data+'" class="btn btn-default btn-xs" title="Sửa"> <i class="fa fa-pencil blue"></i> </a>';
                    txt += '<a class="btn-default btn-xs btn delete-btn" href="'+baseUrl+'delete/'+data+'" title="Xóa"><i class="fa fa-trash-o red"></i></a>';
                    return txt;
                }
            }
        ],
