...
*/
$autoload['helper'] = array('link_helper','cms_helper','form','url','image_helper', 'cookie', 'language');
...
|
*/
$autoload['language'] = array('hotel_lang', 'label_lang', 'restaurant_lang', 'transfer_lang', 'cms_lang');
