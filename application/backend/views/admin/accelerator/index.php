        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <a class="btn btn-success btn-sm" href="/accelerator/edit" style="color:#fff;"><i class="fa fa-plus"></i> Thêm mới </a>
                </div><!-- /.box-header -->
                <div class="box-body table-responsive">
                    <table id="datatable" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php if(!empty($accelerator)) : foreach($accelerator as $key => $value) : ?>
                            <tr id="row-item-<?=$value->id;?>">
                                <td><?=$value->order;?></td>
                                <td style="max-width:100px" class="text-center">
                                    <img src="<?php echo $value->logo ?>" alt="Logo" style="max-width:100px;height:60px">
                                </td>
                                <td><a href="/accelerator/edit/<?php echo $value->id; ?>"><?php echo $value->name; ?></a></td>
                                <td class="text-center"><?php echo $value->status_name ?></td>
                                <td class="text-center"><?php echo $value->type_name ?></td>
                                <td class="text-center"><?php echo $value->intro ?></td>
                                <td class="center">
                                    <a class="btn-default btn" style="margin:5px 0;padding:0 3px" href="<?php echo '/accelerator/edit/', $value->id;?>"><i class="fa fa-pencil-square-o"></i></a>&nbsp;
                                    <?php /*
