...
<script>
    ...
    //     $.get('/manage_post/apis/checkPhone', {phone, id}, (res) => {
    //         if (res.code!=200) 
    ...
    //     let id = $('input[name="id"]').val();
    //     $.get('/manage_post/apis/checkAddress', {address, province_id, district_id, id}, (res) => {
    //         if (res.msg=='already') 
    ...
    let fetchListLocation = function(id, type)
    {
        $.ajax({
            type : 'get',
            dataType : 'json',
            url: '/manage_post/getListLocationByPrarent',
