...
<script>
    ...
    $(document).on('click','#quick-search-btn', function(){
        ...
        $.get(domain + 'apis/tokenSearchProduct/?q='+keyword+'&type=stay', function(resp){
    ...
    $(document).on('click','#quick-search-result li', function(){
        ...
        var id = $(this).data('id');
        var name = $(this).html();
        var selected = '<li class="ui-state-default"><input type="hidden" name="hot_stay[]" value="'+id+'">'+name+'</li>';
