<div class="box-header" style="width:300px;padding:0 0 0 20px">
    <h3 class="box-title"> Box Truyền Hình </h3>
</div>
        ...
        <div class="col-md-6">
            <div class="box box-primary">
                ...
                <div class="box-body" id="menu-listing">
                    <ul id="sortable">
                        <?php if($order_ids) : foreach($order_ids as $id) : if(isset($static_videos[$id])) : $val = $static_videos[$id];?>
                        <li class="ui-state-default">
                            <input type="hidden" name="static_videos[]" value="<?php echo $val->id; ?>">
                            <?php echo $val->title;?>
                        </li>
