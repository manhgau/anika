<div class="box-header" style="width:300px;padding:0 0 0 20px">
    <h3 class="box-title"> Bài nên đọc </h3>
</div>
        ...
        <div class="col-md-6">
            <div class="box box-primary">
                ...
                <div class="box-body" id="menu-listing">
                    <ul id="sortable">
                        <?php if($editor_order_ids) : foreach($editor_order_ids as $id) : if( isset($editor_choise[$id]) ) : $val = $editor_choise[$id];?>
                        <li class="ui-state-default">
                            <input type="hidden" name="editor_choise[]" value="<?php echo $val->id; ?>">
                            <?php echo $val->title;?>
                        </li>
