<div class="box-header" style="width:300px;padding:0 0 0 20px">
    <h3 class="box-title"> Ẩn khỏi Box Tin Mới (Trang chủ) </h3>
</div>
<section class="content">
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Danh sách ẩn</h3>
                </div>
                <div class="box-body" id="menu-listing">
                    <ul id="sortable">
                        <?php if($order_ids) : foreach($order_ids as $id): if( isset($static_lastest_news[$id]) ) : $val = $static_lastest_news[$id];?>
                        <li class="ui-state-default">
                            <input type="hidden" name="static_lastest_news[]" value="<?php echo $val->id; ?>">
                            <?php echo $val->title;?>
                        </li>
