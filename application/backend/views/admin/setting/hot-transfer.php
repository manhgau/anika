<div class="box-header" style="width:300px;padding:0 0 0 20px">
    <h3 class="box-title"> HOT Stay </h3>
</div>
<section class="content">
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">HOT Transfer</h3>
                </div>
                <div class="box-body" id="menu-listing">
                    <ul id="sortable">
                        <?php if($order_ids) : foreach($order_ids as $id) : $val = $hot_transfer[$id];?>
                        <li class="ui-state-default">
                            <input type="hidden" name="hot_transfer[]" value="<?php echo $val->id; ?>">
                            <?php echo $val->title;?>
                        </li>
