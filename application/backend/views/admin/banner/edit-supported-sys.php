                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        <div class="form-group row">
                            <div class="col-xs-4">
                                <p style="margin-bottom:0">&nbsp;</p>
                                    ...
                                    <br>
                                    <label class="hidden"><?php echo form_checkbox('is_blank','1',($banner->is_blank==1) ? TRUE : FALSE,'class="simple" id="is_blank"');?>&nbsp;Blank click</label>
                            </div>
                        ...
                        <div class="form-group">
                            <div class=" col-md-4">
                                <label for="exampleInputEmail1" title="Chiều cao ảnh: 50px">Ảnh <small class="thin">(... x 50px)</small></label><br>
                                ...
                                <button id="addmore-image" class="btn btn-sm btn-default hidden"> Chèn ảnh vào quảng cáo</button>
